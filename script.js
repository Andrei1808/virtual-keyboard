...
const textValues = ['CapsLock', 'Shift', 'Backspace', 'Enter', 'Ctrl', 'Tab', 'Delete', 'Alt', 'AltRight', 'ArrowRight', 'ArrowLeft', 'ArrowUp', 'ArrowDown', 'Win'];

const middleButtons = ['Ctrl', 'Tab'];
const bigButtons = ['CapsLock', 'Shift', 'Backspace', 'Enter'];
...
const infoTextOperationgSystem = createElement(
  {
    tag: 'p',
    classList: ['info-text'],
...
const infoTextButtonsCombination = createElement(
  {
    tag: 'p',
    classList: ['info-text'],
